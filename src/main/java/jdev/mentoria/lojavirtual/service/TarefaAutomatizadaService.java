...
public class TarefaAutomatizadaService {
	...
	@Scheduled(cron = "0 0 11 * * *",zone = "America/Sao_Paulo")/* Vai rodar todo dia as 11 horas da manha horário de brasília */
	public void notificarUserTrocaSenha() throws UnsupportedEncodingException, MessagingException, InterruptedException {
		...
		for (Usuario usuario : usuarios) {
			...
			msg.append("Está na hora de trocar sua senha, já passou 10 dias de validade.").append("<br/>");
			msg.append("Troque sua senha a loja virtual do Wagner - Wagner vendas");
